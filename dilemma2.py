...
def sum_scores(history):
    return sum(3 if move == 'C' else 1 for move in history)
...
def main():
    ...
    # Calculate and display the sum of scores after the final round
    final_score_p1 = player1.history.count('C')
    final_score_p2 = player2.history.count('C')
    print("Game Over! Final Scores - Player 1: {}, Player 2: {}".format(final_score_p1, final_score_p2))
    print("Sum of Scores - Player 1: {}, Player 2: {}".format(sum_scores(player1.history), sum_scores(player2.history)))
